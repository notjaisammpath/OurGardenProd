...
class Back4app{
  ...
  void doUserLogout(BuildContext context) async {
    ...
    Future<bool> doUserLogin(String username, String password, BuildContext context) async {
    ...
    Future<bool> doUserRegistration(String username, String email, String password, BuildContext context) async {
